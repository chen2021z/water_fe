<template>
	<view>
		...
		<view class="uni-uploader px-2" v-show="showAddImg">
				...
				<view class="uni-uploader__files">
					<block v-for="(image,index) in imageList" :key="index">
						<view class="uni-uploader__file position-relative">
							...
							<view class=" position-absolute top-0 right-0 px-2 py-2 rounded" style="background-color: rgba(0,0,0,0.2);" @click.stop="deleteIamge(index)">
